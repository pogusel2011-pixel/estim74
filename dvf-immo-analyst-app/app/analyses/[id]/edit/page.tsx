    ...
    fetch(`/api/analyses/${params.id}`)
      ...
      .then((data) => {
        ...
        const vals: Partial<PropertyFormValues> = {
          ...
          hasBruit: data.hasBruit ?? false,
          hasCopropDegradee: data.hasCopropDegradee ?? false,
          hasExpositionNord: data.hasExpositionNord ?? false,
          hasRDCSansExterieur: data.hasRDCSansExterieur ?? false,
