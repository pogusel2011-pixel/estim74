  ...
  return (
    <aside className={cn(
      ...
      <div className="flex items-center h-14 px-3 border-b border-sidebar-border shrink-0">
        <BarChart3 className="h-5 w-5 text-sidebar-primary shrink-0" />
        {open && <span className="ml-2 font-bold text-sm tracking-tight text-sidebar-foreground truncate">ESTIM&#39;74</span>}
      </div>
      ...
      <div className="p-2 border-t border-sidebar-border">
        <Button variant="ghost" size="sm" onClick={onToggle} className="w-full justify-center text-sidebar-foreground/60 hover:text-sidebar-foreground hover:bg-sidebar-accent">
